...
const DownloadIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <path d="M12 2v14m0 0l-5-5m5 5l5-5M4 20h16" />
  </svg>
);
        ...
        >
          ...
          >
            ...
            <a
              ...
              className="contact-modal-primary"
            >
              <MailIcon />
              <span>duljamarin@gmail.com</span>
            </a>

            <div className="contact-modal-secondary">
              <a
            ...
            <div className="contact-modal-socials">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="contact-modal-social"
                aria-label="LinkedIn"
              >
                <LinkedInIcon />
              </a>
              <a
                href="https://github.com/duljamarin"
                target="_blank"
                rel="noopener noreferrer"
                className="contact-modal-social"
                aria-label="GitHub"
